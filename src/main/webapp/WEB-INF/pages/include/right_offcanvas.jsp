...
<div class="offcanvas offcanvas-end bg-warning bg-gradient" tabindex="-1" id="right-offcanvas" aria-labelledby="right-offcanvas-label" style="width:40%;">
  <div class="offcanvas-header">
    <h5 class="offcanvas-title" id="left-offcanvas-label">购物车</h5>
    <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
  </div>
  <div class="offcanvas-body">
    <h3>合计：<span id="total-amount" style="color: red;">￥0.00</span></h3>
    <button class="btn btn-success" type="button" style="min-width:100%;">
    ...
    <div class="row" style="margin-top:30px">
          <div class="col">
            <div id="cart-grid" class="grid text-center" style="--bs-columns: 2;">
                <!-- card -->
            </div>
          </div>
    </div>
